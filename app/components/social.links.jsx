...
const SocialLinks = () => {
  const socials = [
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@rufussweeneymd",
      icon: (props) => (
      ...
      color: "hover:text-[#000000]", // TikTok black
    },
    {
      name: "YouTube",
      href: "https://youtube.com/@rufussweeneymd",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/rufussweeneymd",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="flex justify-center space-x-8">
        {socials.map((item) => (
          <a
            ...
            aria-label={`Follow Dr. Rufus on ${item.name}`}
          >
